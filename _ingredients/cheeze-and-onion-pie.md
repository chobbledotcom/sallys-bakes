...
Nutritional yeast (dried inactive yeast, thiamine (B1), riboflavin (B2), niacin (B3), pantothenic acid (B5), pyridoxine (B6), biotin (B7), folic acid (B9), cyanocobalamin (B12), zinc sulphate)
